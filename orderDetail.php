...
$sql = "SELECT A.order_id,A.product_id,B.name,A.product_qty,B.price,A.detail_total FROM `order_detail` A JOIN `tbl_product` B on A.product_id = B.id WHERE A.order_id = '$order_id'";
