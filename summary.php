      ...
      <div class="container mt-4">
        ...
        ?>
            <div class="row mt-4 d-flex justify-content-center">
              ...
              <div class="col-4">
                <input type="text" id="name" name="name" class="form-control" placeholder="ชื่อ-นามสกุล" value='<?php echo $row["firstname"] . " " . $row["lastname"]; ?>' />
              </div>
            </div>
            <div class="row mt-2 d-flex justify-content-center">
              ...
              <div class="col-4">
                <textarea class="form-control" type="text" id="address" name="address" placeholder="ที่อยู่"><?php echo $row["address"]; ?> </textarea>
              </div>
            </div>
            <div class="row mt-2 d-flex justify-content-center">
              <div class="col-2">
            ...
            <div class="row mt-2 d-flex justify-content-center">
              ...
              <div class="col-4">
                <input type="text" id="tel" name="tel" class="form-control" placeholder="เบอร์โทรศัพท์" value='<?php echo $row["tel"]; ?>' />
              </div>
            </div>
